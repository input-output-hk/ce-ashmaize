...
# assert_eq!(
#      digest,
#      [1, 220, 164, 16, 227, 19, 156, 77, 246, 32, 169, 213, 26, 180, 202, 110, 134, 239, 145, 174, 38, 44, 70, 86, 12, 131, 94, 86, 36, 77, 87, 211, 59, 39, 175, 21, 203, 63, 182, 179, 221, 9, 21, 232, 136, 87, 79, 121, 76, 141, 47, 143, 240, 207, 84, 236, 235, 99, 96, 98, 177, 86, 165, 114]
# );```
    ...
    */
    ...
    fn test_eq() {
        ...
        const EXPECTED: [u8; 64] = [
            97, 69, 158, 30, 244, 24, 218, 189, 3, 54, 151, 98, 200, 4, 62, 231, 184, 194, 171,
            216, 239, 111, 203, 126, 147, 122, 208, 115, 233, 235, 21, 186, 41, 111, 126, 98, 151,
            26, 55, 151, 8, 154, 0, 139, 126, 125, 130, 54, 168, 228, 194, 194, 207, 57, 176, 213,
            167, 178, 155, 70, 21, 200, 18, 168,
        ];
